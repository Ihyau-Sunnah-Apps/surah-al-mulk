...
function myFunction(xml) {
    ...
    txt = "";
    x = xmlDoc.getElementsByTagName('ayam'); //Get all 'ayam' tags in xml file
    //Loop through the tags and store them in var txt
    for (i = 1 ; i <x.length; i++) {
        txt += "<img class='center fit' src='images/67_" + i + ".png'/><br><strong>["+ x[i].getAttribute('index') + "] " + x[i].getAttribute('text') + "<br></strong>";
    }
